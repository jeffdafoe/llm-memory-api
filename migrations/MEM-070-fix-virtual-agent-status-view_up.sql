-- MEM-070: Fix agent_status view for virtual agent status display
--
-- The view was showing 'active' (the actors.status default) for virtual agents
-- instead of 'available'. Now maps 'active' to 'available' for virtual agents,
-- and shows the real status (degraded, error) when set.
