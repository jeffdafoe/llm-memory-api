...
router.post('/discussion/status', apiRoute('discussion', 'status', async (req, res) => {
...
router.post('/discussion/vote/status', apiRoute('discussion', 'vote-status', async (req, res) => {
